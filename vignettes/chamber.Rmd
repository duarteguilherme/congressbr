...
The function return 19 variables, including the decision situation of the proposition (`situation_desc`), the full text in pdf (`complete_link`), and personal information about the author of the proposition (`name_author`, `author_state`, and `author_party`).
