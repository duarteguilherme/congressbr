...
`congressbr` can be used for various types of analyses, and as a quick example, let's explore the distribution of men and women currently sitting in the house. (This example makes use of the `ggplot2` package.)
